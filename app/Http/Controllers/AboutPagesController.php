...
class AboutPagesController extends Controller
{
    ...
    public function create()
    {
        ...
        // $service=Portfolio::first();,compact('service')
    ...
    public function store(Request $request)
    {
        ...
        $abouts->save();
        return redirect()->route('admin.abouts.create')->with('success','New Abouts Create Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $about->delete();
        return redirect()->route('admin.abouts.list')->with('success',' About Delete Successfully');
